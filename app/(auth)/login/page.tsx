...
import { Bot, Mail, Key, Loader2, ArrowRight } from 'lucide-react'
        ...
        <form className="space-y-4" onSubmit={handleLogin}>
          <div className="space-y-3.5">
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2.5 px-3 py-2.5 w-full rounded-xl bg-slate-950 border border-slate-850 text-slate-400 focus-within:border-blue-500/50 transition-colors">
                <Key className="w-4 h-4 text-slate-655 shrink-0" />
                <input
                  type="password"
                  value={password}
          ...
          >
            {loading ? (
              <>
                <Loader2 className="w-4 h-4 animate-spin text-white" /> Loading Profile...
              </>
            ) : (
              <>
